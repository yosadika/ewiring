...
<!-- Font Awesome Icons -->
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/back/AdminLTE/plugins/fontawesome-5/css/all.min.css">
<!-- IonIcons -->
<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
<!-- Theme style -->
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/back/AdminLTE/dist/css/adminlte.min.css">
<!-- Daterange picker -->
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/back/AdminLTE/plugins/daterangepicker/daterangepicker.css">
<!-- DataTables -->
...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/back/AdminLTE/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/back/AdminLTE/plugins/sweetalert2/sweetalert2.min.css">