                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $data_wiring->judul_pdf ?>" id="judul_pdf" placeholder="Masukkan judul buku wiring" name="judul_pdf" required>
                      ...
                      <div class="form-group clearfix row">
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="500 KV" id="radio500" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "500 KV") ? "checked" : "" ?> required>
                            <label for="radio500">
                              500 KV
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="275 KV" id="radio275" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "275 KV") ? "checked" : "" ?> required>
                            <label for="radio275">
                              275 KV
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="150 KV" id="radio150" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "150 KV") ? "checked" : "" ?> required>
                            <label for="radio150">
                              150 KV
                            </label>
                          </div>
                        ...
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="70 KV" id="radio70" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "70 KV") ? "checked" : "" ?> required>
                            <label for="radio70">
                              70 KV
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="20 KV" id="radio20" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "20 KV") ? "checked" : "" ?> required>
                            <label for="radio20">
                              20 KV
                            </label>
                          </div>
                        ...
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="220 VAC" id="radio220" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "220 VAC") ? "checked" : "" ?> required>
                            <label for="radio220">
                              220 VAC
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="110 VDC" id="radio110" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "110 VDC") ? "checked" : "" ?> required>
                            <label for="radio110">
                              110 VDC
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="48 VDC" id="radio48" name="radioTeganganperalatan" <?php echo ($data_wiring->level_tegangan == "48 VDC") ? "checked" : "" ?> required>
                            <label for="radio48">
                              48 VDC
                            </label>
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-group clearfix">
                        <div class="icheck-primary d-inline">
                          <input type="radio" value="SISTEM DC" id="radioSistemdc" name="radioKategoriperalatan" <?php echo ($data_wiring->kategori_peralatan == "SISTEM DC") ? "checked" : "" ?> required>
                          <label for="radioSistemdc">
                            Sistem DC
                          </label>
                        </div>
                        <div class="icheck-primary d-inline">
                          <input type="radio" value="BAY" id="radioBay" name="radioKategoriperalatan" <?php echo ($data_wiring->kategori_peralatan == "BAY") ? "checked" : "" ?> required>
                          <label for="radioBay">
                            Bay
                          </label>
                        </div>
                        <div class="icheck-primary d-inline">
                          <input type="radio" value="ALAT PEREKAM" id="radioAlatperekam" name="radioKategoriperalatan" <?php echo ($data_wiring->kategori_peralatan == "ALAT PEREKAM") ? "checked" : "" ?> required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group clearfix row">
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="PENGHANTAR" id="radioPenghantar" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "PENGHANTAR") ? "checked" : "" ?> required>
                            <label for="radioPenghantar">
                              Penghantar
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="TRAFO" id="radioTrafo" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "TRAFO") ? "checked" : "" ?> required>
                            <label for="radioTrafo">
                              Trafo
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="KOPEL" id="radioKopel" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "KOPEL") ? "checked" : "" ?> required>
                        ...
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="KAPASITOR" id="radioKapasitor" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "KAPASITOR") ? "checked" : "" ?> required>
                            <label for="radioKapasitor">
                              Kapasitor
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="DIAMETER" id="radioDiameter" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "DIAMETER") ? "checked" : "" ?> required>
                            <label for="radioDiameter">
                              Diameter
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="BUSBAR" id="radioBusbar" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "BUSBAR") ? "checked" : "" ?> required>
                        ...
                        <div class="col">
                          <div class="icheck-primary">
                            <input type="radio" value="ACDC" id="radioAcdc" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "ACDC") ? "checked" : "" ?> required>
                            <label for="radioAcdc">
                              AC/DC
                            </label>
                          </div>
                          <div class="icheck-primary">
                            <input type="radio" value="ALAT PEREKAM" id="radioAlatperekam2" name="radioKategorilanjutan" <?php echo ($data_wiring->kategori_bay == "ALAT PEREKAM") ? "checked" : "" ?> required>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="form-group clearfix row">
                        <div class="col">
                          <div class="icheck-primary d-inline">
                            <input type="radio" value="AS BUILT" id="radioAsbuilt" name="radioKategoriwiring" <?php echo ($data_wiring->kategori_wiring == "AS BUILT") ? "checked" : "" ?> required>
                            <label for="radioAsbuilt">
                              As Built
                            </label>
                          </div>
                          <div class="icheck-primary d-inline">
                            <input type="radio" value="INTERNAL PERALATAN" id="radioInternalperalatan" name="radioKategoriwiring" <?php echo ($data_wiring->kategori_wiring == "INTERNAL PERALATAN") ? "checked" : "" ?> required>
                            <label for="radioInternalperalatan">
                              Internal Peralatan
                            </label>
                          </div>
                          <div class="icheck-primary d-inline">
                            <input type="radio" value="PANEL KOMUNIKASI" id="radioPanelkomunikasi" name="radioKategoriwiring" <?php echo ($data_wiring->kategori_wiring == "PANEL KOMUNIKASI") ? "checked" : "" ?> required>
                  ...
                  <div class="col-md-9">
                    <div class="form-group">
                      ...
                      <div class="form-group clearfix row">
                          <div class="col">
                            <div class="icheck-primary">
                              <input type="radio" value="INTERNAL PMT" id="radioInternalPMT" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "INTERNAL PMT") ? "checked" : "" ?> required>
                              <label for="radioInternalPMT">
                                Internal PMT
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="INTERNAL PMS BUS" id="radioInternalPMSbus" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "INTERNAL PMS BUS") ? "checked" : "" ?> required>
                              <label for="radioInternalPMSbus">
                                Internal PMS Bus
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="INTERNAL PMS LINE" id="radioInternalPMSline" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "INTERNAL PMS LINE") ? "checked" : "" ?> required>
                              <label for="radioInternalPMSline">
                                Internal PMS Line
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="INTERNAL PMS GROUND" id="radioInternalPMSground" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "INTERNAL PMS GROUND") ? "checked" : "" ?> required>
                          ...
                          <div class="col">
                            <div class="icheck-primary">
                              <input type="radio" value="INTERNAL TRAFO" id="radioInternaltrafo" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "INTERNAL TRAFO") ? "checked" : "" ?> required>
                              <label for="radioInternaltrafo">
                                Internal Trafo
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="KUBIKEL" id="radioKubikel" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "KUBIKEL") ? "checked" : "" ?> required>
                              <label for="radioKubikel">
                                Kubikel
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="PANEL KONTROL DAN PROTEKSI" id="radioPanelkontroldanproteksi" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "PANEL KONTROL DAN PROTEKSI") ? "checked" : "" ?> required>
                              <label for="radioPanelkontroldanproteksi">
                                Panel Kontrol dan Proteksi
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="RELAY" id="radioRelay" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "RELAY") ? "checked" : "" ?> required>
                          ...
                          <div class="col">
                            <div class="icheck-primary">
                              <input type="radio" value="KWH" id="radioKWH" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "KWH") ? "checked" : "" ?> required>
                              <label for="radioKWH">
                                KWH
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="PANEL KWH" id="radioPanelkwh" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "PANEL KWH") ? "checked" : "" ?> required>
                              <label for="radioPanelkwh">
                                Panel KWH
                              </label>
                            </div>
                            <div class="icheck-primary">
                              <input type="radio" value="KABEL SCHEDULE" id="radioCableschedule" name="radioSubkategoriwiring" <?php echo ($data_wiring->sub_kategori_wiring == "KABEL SCHEDULE") ? "checked" : "" ?> required>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" placeholder="Ini adalah buku Internal Trafo merk Unindo..." name="keterangan" id="keterangan" required><?php echo $data_wiring->keterangan ?></textarea>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
