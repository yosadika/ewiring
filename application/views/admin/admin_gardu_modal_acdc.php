<div class="modal fade" id="modal-acdc">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Wiring Sistem DC</h4>
        ...
        <div class="modal-body">
          <div class="card-body table-responsive">
            <table id="table-acdc" class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Bay</th>
              ...
              <tbody>
                <?php
                  $no = 1;                            
                  foreach($data_buku_acdc as $hasil){
                ?>
                ...
                <div class="modal fade" id="myModal-acdc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
